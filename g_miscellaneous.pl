...
% 7.03 (***) Von Koch's conjecture Several years ago I met a mathematician who
% was intrigued by a problem for which he didn't know a solution. His name was
% Von Koch, and I don't know whether the problem has been solved since.
...
% Sudoku puzzles go like this: Problem statement Solution

% . . 4 | 8 . . | . 1 7 9 3 4 | 8 2 5 | 6 1 7 | | | | 6 7 . | 9 . . | . . . 6 7
% 2 | 9 1 4 | 8 5 3 | | | | 5 . 8 | . 3 . | . . 4 5 1 8 | 6 3 7 | 9 2 4
% --------+---------+-------- --------+---------+--------
% 3 . . | 7 4 . | 1 . . 3 2 5 | 7 4 8 | 1 6 9 | | | | . 6 9 | . . . | 7 8 . 4 6
% 9 | 1 5 3 | 7 8 2 | | | | . . 1 | . 6 9 | . . 5 7 8 1 | 2 6 9 | 4 3 5
% --------+---------+-------- --------+---------+--------
% 1 . . | . 8 . | 3 . 6 1 9 7 | 5 8 2 | 3 4 6 | | | | . . . | . . 6 | . 9 1 8 5
% 3 | 4 7 6 | 2 9 1 | | | | 2 4 . | . . 1 | 5 . . 2 4 6 | 3 9 1 | 5 7 8
...
% given only these lengths. Problem statement: Solution:

% |_|_|_|_|_|_|_|_| 3 |_|X|X|X|_|_|_|_| 3 |_|_|_|_|_|_|_|_| 2 1
% |X|X|_|X|_|_|_|_| 2 1 |_|_|_|_|_|_|_|_| 3 2 |_|X|X|X|_|_|X|X| 3 2
% |_|_|_|_|_|_|_|_| 2 2 |_|_|X|X|_|_|X|X| 2 2 |_|_|_|_|_|_|_|_| 6
% |_|_|X|X|X|X|X|X| 6 |_|_|_|_|_|_|_|_| 1 5 |X|_|X|X|X|X|X|_| 1 5
% |_|_|_|_|_|_|_|_| 6 |X|X|X|X|X|X|_|_| 6 |_|_|_|_|_|_|_|_| 1 |_|_|_|_|X|_|_|_|
% 1 |_|_|_|_|_|_|_|_| 2 |_|_|_|X|X|_|_|_| 2 1 3 1 7 5 3 4 3 1 3 1 7 5 3 4 3 2 1
% 5 1 2 1 5 1
...
% the words (one word per line) in an arbitrary order. Then, after an empty
...
% solution easier, character locations can also contain predefined character
% values. The puzzle opposite is defined in the file p7_09a.dat, other examples
% are p7_09b.dat and p7_09d.dat. There is also an example of a puzzle
% (p7_09c.dat) which does not have a solution.
...
% is a clean solution, not just a quick-and-dirty hack! (2) Reading the data
% file is a tricky problem for which a solution is provided in the file
% p7_09-readfile.pl. Use the predicate read_lines/2.
